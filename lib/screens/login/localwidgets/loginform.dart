...
import 'package:goschedule2/screens/signup/signup.dart';
    ...
    return OurContainer(
      child: Column(
        children: <Widget>[
          ...
          SizedBox(height: 20.0,),
          RaisedButton(child: Padding(padding: EdgeInsets.symmetric(horizontal: 100),child: Text('Log In',style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20.0),)
          ),
            onPressed: (){
